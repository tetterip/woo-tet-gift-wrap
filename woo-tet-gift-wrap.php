...
define( 'TET_GIFT_WRAP_VERSION', get_file_data( __FILE__, [ 'Version' => 'Version' ] )['Version'] );
...
// Load translations on init (avoids the WP 6.7+ just-in-time loading notice).
add_action( 'init', function () {
	load_plugin_textdomain( 'tet-gift-wrap', false, dirname( plugin_basename( __FILE__ ) ) . '/languages' );
} );
...
// Updates + "All Plugins" page (shared ttrp-common library).
require_once plugin_dir_path( __FILE__ ) . 'ttrp-common/loader.php';
ttrp_common_register( __FILE__, 'woo-tet-gift-wrap' );
